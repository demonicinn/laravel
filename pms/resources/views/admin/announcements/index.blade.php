	...
	<div class="col-md-12">       
		<div class="card">
			<div class="card-heading">
				<h5>@yield('title')
					<a href="{{route('announcements.add')}}" class="btn btn-round btn-success space-preview pull-right"><i class="fa fa-plus" aria-hidden="true"></i> Add</a>
				</h5>
			</div>
			<div class="card-body">
					...
					<tbody>
						...
						<tr>
							...
							<td>
								...
								@endif
								&nbsp;&nbsp;
								<a href="{{url('announcements/edit/'.base64_encode($row->id.'/'.time()))}}" title="Edit" class="warning"><i class="fa fa-pencil-square-o"></i></a>&nbsp;&nbsp;
