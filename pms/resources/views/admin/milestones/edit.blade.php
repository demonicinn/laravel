	...
	<div class="col-md-8">
		<div class="card">
			<div class="card-heading">
				<h5>@yield('title')
					<a href="{{route('milestones')}}" class="btn btn-round btn-success space-preview pull-right"><i class="fa fa-arrow-circle-left" aria-hidden="true"></i> Back</a>
				</h5>
			</div>
			<div class="card-body">
				<form data-toggle="validator" method="POST" action="{{ route('milestones.update') }}">
				{{ csrf_field() }}
